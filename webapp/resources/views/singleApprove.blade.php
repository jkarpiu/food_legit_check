...
<article class="product-approve">
    ...
    <h2 data-aos="fade-right" data-aos-delay="2200"><span class="title-product">Zatwierdzone:</span> @if ($product -> isApproved == 0) <span style="color:red;">NIE</span>@else <span style="color: green;">TAK</span>@endif</h2>
    <section class="operations">
        @if (Auth::user()->role == 'Admin')
        <a href="{{ url('/dashboard/approve/'.$product-> product_id.'/add') }}" class="approve" data-aos="fade-up" data-aos-delay="2200">Zatwierdź</a>
        @endif
        <a href="{{ url('/dashboard/approve/'.$product-> product_id.'/edit') }}" class="edit" data-aos="fade-up" data-aos-delay="2400">Edytuj</a>
        <a href="{{ url('/dashboard/approve/'.$product -> product_id.'/delete') }}" class="delete" data-aos="fade-up" data-aos-delay="2600">Usuń</a>
